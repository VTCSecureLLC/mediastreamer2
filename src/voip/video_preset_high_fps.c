...
static MSVideoConfiguration high_fps_desktop_h264_conf_list[] = {
	...
	MS_VIDEO_CONF(1000000, 1500000, SVGA, 30, 4),
	MS_VIDEO_CONF( 600000, 1000000,  VGA, 30, 2),
	MS_VIDEO_CONF( 250000,  600000,  CIF, 30, 2),
	MS_VIDEO_CONF( 210000,  250000, QVGA, 30, 2),
	MS_VIDEO_CONF( 150000,  210000, QCIF, 30, 1),
	MS_VIDEO_CONF( 100000,  150000, QCIF, 15, 1),
	MS_VIDEO_CONF(      0,  100000, QCIF, 10, 1)
};
